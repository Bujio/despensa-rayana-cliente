...
export const defaultHomeContent = {
  ...
  featuredProductIds: [],
  sections: [
    { id: 'hero', type: 'hero', title: 'Hero principal', enabled: true, locked: true, ...defaultEditorialFields },
    { id: 'trust', type: 'trust', title: 'Mensajes de confianza', enabled: true, locked: true, items: defaultTrustItems, ...defaultEditorialFields },
    { id: 'categories', type: 'categories', title: 'Explora nuestras categorías', enabled: true, locked: true, items: defaultCategoryItems, ...defaultEditorialFields },
    { id: 'featured', type: 'featured', title: 'Productos destacados', enabled: true, locked: true, ...defaultEditorialFields },
  ],
};
